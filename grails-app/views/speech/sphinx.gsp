...
<html>
  ...
  <body>
    <header>
      <div class="inner">
        <a href="http://syl22-00.github.io/pocketsphinx.js"><h1>Pocketsphinx.js</h1></a>
    ...
    <script src="js/sphinx/audioRecorder.js"></script>
    <script src="js/sphinx/callbackManager.js"></script>
