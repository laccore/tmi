...
<html>
    <head>
        ...
        <title>TMI - Smear Slides - Organic Components</title>
    </head>
    <body>
        <div class="nav">
                ...
                <table>
                    ...
                    <g:each in="${uniqueIdentificationInstanceList}" status="i" var="uniqueIdentificationInstance">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <td><g:link controller="uniqueIdentification" action="show" id="${uniqueIdentificationInstance.id}">${fieldValue(bean: uniqueIdentificationInstance, field: "id")}</g:link></td>
