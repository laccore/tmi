<div id="sscomp${i}" class="sscomp-div" <g:if test="${hidden}">style="display:none;"</g:if>>
    ...
    <g:select name='components[${i}].component.id' from="${edu.umn.laccore.tmi.SedimentComponent.descendingList()}" optionKey="id" value='${sscomp?.component?.id}' style="width:210px;" onchange='onAbundanceChange()'/>
	<g:textField type='number' size='4' name='components[${i}].percentage' value='${sscomp?.percentage}' onchange='onAbundanceChange()' />
